...
Уважаемый соискатель, перед Вами тест на вакансию C# программист. Мы предлагаем выполнить Вам несложное задание, чтобы Вы могли продемонстрировать Вашу способность писать такой код.
